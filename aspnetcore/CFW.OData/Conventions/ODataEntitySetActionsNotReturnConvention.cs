...
namespace CFW.OData.Conventions
{
    ...
    internal class ODataEntitySetActionsNotReturnConvention : Attribute, IControllerModelConvention
    {
        public void Apply(ControllerModel controller)
        {
            if (
                !controller.ControllerType.IsGenericType
                || controller.ControllerType.GetGenericTypeDefinition() != typeof(ODataEntitySetActionsReturnEmptyController<,,>)
            )
            {
                return;
            }
            ...
            {
                { nameof(ODataEntitySetActionsReturnEmptyController<object, Guid, object>.PostAction), HandleBoundedAction },
                { nameof(ODataEntitySetActionsReturnEmptyController<object, Guid, object>.PostUnboundAction), HandleUnboundAction },
            };
